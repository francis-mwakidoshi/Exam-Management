...
<!-- Services-->
 <?php
    ...
    {
        $edit_id = $_GET['edit'];
        $sel = "select * from scriptscollection where id='$edit_id'";
					    ...
					    <div class="row g-0">
									<div class="col-md-8">
									  <div class="card-body">
										...
										<div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">Lectures Name  &nbsp;<i class="fa-solid  fa-book"></i></span> 
												   <input type="text" class="form-control" id="lecturesName" name="lecturesName" value="<?php echo $lecturesName; ?>">
											</div>
                                            <div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">Exam Name  &nbsp;<i class="fa-solid  fa-book"></i></span> 
												   <input type="text" class="form-control" id="examName" name="examName" value="<?php echo $examName; ?>">
											</div>
                                            <div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">Exam Code  &nbsp; <i class="fa-solid fas fa-barcode"></i></i></span> 
												   <input type="text" class="form-control" id="examCode" name="examCode" value ="<?php echo $examCode; ?>">
											</div>
		
											
											<div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">numberOfScripts  &nbsp; <i class="fa-solid fa-user-check"></i></i></span> 
												   <input type="text" class="form-control" id="numberOfScripts" name="numberOfScripts" value ="<?php echo $numberOfScripts; ?>">
											</div>
											
											<div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">Lecturer Contact  &nbsp; <i class="fa-solid fa-phone"></i></i></span> 
												   <input type="text" class="form-control" id="LecturerContact" name="LecturerContact" value ="<?php echo $LecturerContact; ?>">
											</div>
											<div class="input-group mb-3 input-group-lg">
												  <span class="input-group-text">status  &nbsp; <i class="fa-solid fa-user-check"></i></i></span> 
						 ...
						 <?php
							if (isset($_POST['update']))
							{
								...
								$update = "UPDATE `scriptscollection` SET `lecturesName` = '$lecturesName' ,`examName` = '$examName', `examCode` = '$examCode', `numberOfScripts` = '$numberOfScripts', `LecturerContact` = '$LecturerContact', `status` = '$status'  WHERE `scriptscollection`.`id`='$edit_id'";
